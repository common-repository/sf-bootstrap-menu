<?php
if (!class_exists('sf_bootstrap_walker_horizontal_menu')) {
class sf_bootstrap_walker_horizontal_menu extends Walker_Page {

	private $curItem, $activeItem, $closedLi;
/**
...
function start_lvl( &$output, $depth = 0, $args = array() ) {
	...
	$output .= "\n$indent<ul class='dropdown-menu collapse' role='menu'>\n";
}
